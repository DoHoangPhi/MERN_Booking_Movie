...
// Inngest Function to cancel booking and release seats of show after 10 minutes of booking created if 
// payment is not made
...
// Inngest Function to send email wher user books a show
    ...
    async ({ event, step }) => {
        ...
        await sendEmail({
            ...
            body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
                    ...
                    <p>Your booking for <strong style="color: #F84565l">
                ...
                reminderTasks.map(task => sendEmail({
                    ...
                    body: `<div style="font-family: Arial, sans-serif; padding: 20px">
                        ...
                        timeZone: 'Asia/Ho_Chi_Minh'
                                ...
                                <strong>${new Date(task.showTime).toLocaleTimeStringString('en-US', {
                        timeZone: 'Asia/Ho_Chi_Minh'
                    })}</strong>
                                </p>
...
// inngest function to sen notifications when a new show is added
    ...
    async ({ event }) => {
        ...
        for (const user of users) {
            ...
            const body = `<div style="font-family: Arial, sans-serif; padding: 20px">
                                    <h2>Hi ${userName}</h2>
                                    <p>We're just added a new show to our library:</p>
