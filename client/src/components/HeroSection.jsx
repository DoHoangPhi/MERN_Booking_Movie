...
const HeroSection = () => {
    ...
    bg-center h-screen'>
            <img src={assets.marvelLogo} className='max-h-11 lg:g-11 mt-20' alt="" />
            ...
            <p className='max-w-md text-gray-300'>
                In a post-apocalyptic world, a ragtag group of unlikely heroes
                must band together to protect the last remnants of civilization
                from cosmic threats and their own haunted pasts.
            </p>
            <button
